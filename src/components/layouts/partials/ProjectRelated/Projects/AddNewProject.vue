                  ...
                  <div class="form-group">
                            ...
                            <div class="row mt-4">
                              <div class="col-md-5">
                                ...
                                <div class="custom-file mb-3">
                                  <input type="file" class="custom-file-input" id="customFile" name="filename" @change="handleImage($event,k)">
                              ...
                              <div class="col-md-5">
                                ...
                                <input class="form-control" type="text" autocomplete="off" v-model="file.file_name">
                              </div>
                              <div class="col-md-2 mt-4" v-if="k==0">
                              </div>
                              <div class="col-md-2 mt-4" v-else>
                    ...
                    <div class="form-row mt-4">
                      ...
                      <div class="col-md-3 permissions">
                        ...
                        <input type="text" class="form-control" v-model="searchAdmin" placeholder="filter">
                    ...
                    <div class="form-group mt-2">
                      <button @submit.prevent="submitProjectForm" class="mt-2 btn btn-success btn-lg float-right">Create Project
                      </button>
                    </div>
                  </div>
                </form>
...
export default {
  ...
  methods: {
    ...
    handleImage(e, index) {
      ...
      console.log("498  zero ////////", files[0], index);
    },
