        ...
        <div v-if="isUpdateVisible" class="modal">
            <div class="main-card card">
                <div class="card-header">
                    <p class="float-left">Update Work Priority Name</p>
                </div>
                <div class="card-body" style="width: 600px">
                    <form @submit.prevent="updateWorkPriority">
                        <div class="form-group">

                            <label>Work Priority Name</label>
                            <input placeholder="Priority Name" id="work_type_name" v-model="name" type="text"
                                   class="form-control"/>
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button @submit.prevent="updateWorkPriority"
    ...
    export default {
        ...
        methods: {
            ...
            getWorkPriorityData: function () {
                axios.get("work-priorities/" + this.update_attendance_id + "/").then(
                    (response) => {
            ...
            updateWorkPriority() {
                axios
                    .put("work-priorities/" + this.update_attendance_id + "/", {
                        name: this.name,
                    })
                    .then((response) => {
                        Swal.fire({
                            ...
                            this.$router.push({name: "WorkPriority"});
                            this.$router.go();
                            console.log(response);
                        });
